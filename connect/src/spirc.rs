use crate::{
    ...
    player_event_listener::{SpircPlayerEvent, SpircPlayerEventListener},
    protocol::{
...
impl Spirc {
    ...
    pub async fn new(
        ...
        let (handle, player_events) = SpircPlayerEventListener::new();
        player.add_player_event_listener(handle);
